...
const MmvaComponent = ({mmva: {dominio, marca, tipoVehiculo, modelo, version, ano, photoName}}) => {
    return (
        <div className="jumbotron mt-5 pb-0">
                <div className="container mt-2 main-card">
                    ...
                    <div className="row pt-5">
                        <div className="col-md-4 text-center fz-25">
                            <p contenteditable="true">{ moment().format('L') }</p>
                            <p contenteditable="true">#2043</p>
                        </div>
                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-md-6 text-center">
                            <div className="dato-basico">
                                ...
                                <p className="option" contenteditable="true">{marca}</p>
                            </div>
                            <div className="dato-basico">
                                <p className="label">Modelo</p>
                                <p className="option" contenteditable="true">{modelo} {version}</p>
                            </div>
                            <div className="dato-basico">
                                <p className="label">Año</p>
                                <p className="option" contenteditable="true">{ano}</p>
                            </div>
                            <div className="dato-basico">
                                <p className="label">Registrado en</p>
                                <p className="option" contenteditable="true">Adrogue N°5 (01264)</p>
                            </div>
                            <div className="dato-basico">
                                <p className="label">Patente bimestral</p>
                                <p className="option" contenteditable="true">$ 2.533,60</p>
                            </div>
                        </div>
                    </div>
                </div>
